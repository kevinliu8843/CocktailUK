...
<div class="row collapse" style="margin-bottom: 40px;">
    <%If blnDuplicated Then%>
        <div class="column large-1"><a href="/account/userHotList.asp?remove=<%=intID%>"><i class="general foundicon-minus">&nbsp;</i></a></div>
        <div class="column large-11"><a href="/account/userHotList.asp?remove=<%=intID%>">Remove from your favourite recipes</a></div>
    <%Else%>
        <div class="column large-1"><a href="/account/userHotList.asp?add=<%=intID%>"><i class="general foundicon-plus">&nbsp;</i></a></div>
