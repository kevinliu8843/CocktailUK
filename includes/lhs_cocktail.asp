...
<a href="/db/Cocktails.asp"><img border="0" src="/images/side_menus/Drinks_right.gif" alt="Cocktails and shooter drinks" width="150" height="42"></a><div>

<div class="item"><img border="0" src="/images/side_menus/smallarrow.gif" width="8" height="8">
...
<div class="item">
<img border="0" src="/images/side_menus/smallarrow.gif" width="8" height="8"><a href="/shop/basket.asp" class="linksin" style="text-decoration: underline;"><strong>View my basket</strong></a><div>

<!--#include virtual="/includes/shop/categoriesleft.asp" -->
<hr style="margin-top: 3px;">

<div class="item">
<img border="0" src="/images/side_menus/smallarrow.gif" width="8" height="8"><a class="linksin" href="/shop/delivery.asp">Delivery prices</a><div>

<div class="item">
<img border="0" src="/images/side_menus/smallarrow.gif" width="8" height="8"><a href="/shop/customerservices.asp" class="linksin">Customer services</a><div>
